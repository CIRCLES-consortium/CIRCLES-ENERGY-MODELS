function [f,P,input_issue] = fuel_model_Pickup_semiprincipled(v,a,g,flag_project)
%FUEL_MODEL_PICKUP_SEMIPRINCIPLED
%   Version 1.0
...
T = readtable('Pickup_semiprincipled_model_evaluations.csv');
V = T.Velocity;
A = T.Acceleration;
G = T.RoadGrade;
F = T.FuelRate;
