function [f,P,input_issue] = fuel_model_Class8Tractor_semiprincipled(v,a,g,flag_project)
%FUEL_MODEL_CLASS8Tractor_SEMIPRINCIPLED
%   Version 1.0
...
T = readtable('Class8Tractor_semiprincipled_model_evaluations.csv');
V = T.Velocity;
A = T.Acceleration;
G = T.RoadGrade;
F = T.FuelRate;
...
% Other constants
%========================================================================
gs2kW = 42.47;                          % grams/sec to kW conversion factor (gasoline)
%========================================================================
% Checks of inputs
%========================================================================
