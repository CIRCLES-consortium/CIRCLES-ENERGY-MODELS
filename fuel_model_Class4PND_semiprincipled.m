function [f,P,input_issue] = fuel_model_Class4PND_semiprincipled(v,a,g,flag_project)
%FUEL_MODEL_CLASS4PND_SEMIPRINCIPLED
%   Version 1.0
...
T = readtable('Class4PND_semiprincipled_model_evaluations.csv');
V = T.Velocity;
A = T.Acceleration;
G = T.RoadGrade;
F = T.FuelRate;
